  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-4">
        <div className="w-9 h-9 rounded-full bg-al-adaam/10 text-al-adaam flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex items-center justify-between gap-3">
        <a
          href="/privacy"
          className="text-xs font-bold text-gray-500 hover:text-al-adaam underline underline-offset-2 transition-colors"
        >
          {lang === 'ar' ? 'اقرأ المزيد' : 'Learn more'}
        </a>
        <button
          onClick={accept}
          className="px-5 py-2 bg-al-adaam hover:bg-al-adaam-dark text-white text-xs font-bold uppercase tracking-wider rounded-full transition-colors shadow-md shadow-al-adaam/20"
        >
